...
## Cylindrical CS
@variables t r θ z h1(r,θ,z) h2(r,θ,z) h3(r,θ,z) U1(r,θ,z) U2(r,θ,z) U3(r,θ,z) Ur(r,θ,z) Uth(r,θ,z) Uz(r,θ,z) ρ T(r,θ,z) P(r,θ,z) Cp Rgas κ(T) μ(T) λ Re γ Mach Pr ϵ;
@variables δU1(r,θ,z)
h = [1 r 1];
x = [r θ z];
U = [U1 U2 U3];
...
open("Test_latexify.txt","w") do file    
    println(file,latexify(Eqns_base[1:4]) );    
end   
